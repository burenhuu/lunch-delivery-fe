...
const Header = ({routerPathName}: any) => {
    ...
    return (
        <header
            className={`w-full flex ${isBackButton ? 'h-[77px]' : 'h-[85px]'} text-center text-white bg-gradient-to-r from-gradient-start to-gradient-end overflow-hidden `}
        >
                    ...
                    <>
                        ...
                        {routerPathName != "/" && officeId && officeName && (
                            <div className="flex">
                                <button
                                    type="button"
                                    className={`flex w-[40px] overflow-x-auto items-center justify-start pl-2.5 py-[5px] gap-x-[5px] h-[30px] text-base text-white rounded-l-[10px] bg-main/20 border-y-[0.5px] border-l-[0.5px] border-main/20`}
                                    onClick={() => {
                                        router.push(`/`);
